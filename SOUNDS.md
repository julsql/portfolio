...
| `fanfare-item.wav` | "Get Item" fanfare — sword pedestal, Triforce piece, Ganon victory, shop purchase | [`OOT_Fanfare_Item.wav`](https://noproblo.dayjo.org/zeldasounds/OOT/OOT_Fanfare_Item.wav) |
...
| `puzzle-solved.wav` | "Riddle solved" jingle — first open of a boss / mini-boss door, also chest opens | [`OOT_Secret.wav`](https://noproblo.dayjo.org/zeldasounds/OOT/OOT_Secret.wav) |
