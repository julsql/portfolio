...
| `link-climb.wav` | Link climbing the ladder in and out of the cave (overworld ↔ cave) | [`OOT_Link_Climb.wav`](https://noproblo.dayjo.org/zeldasounds/OOT/OOT_Link_Climb.wav) |
...
**Counts** — 62 SFX samples (OOT) + 5 music tracks.
